...
<div class="row">
    <div class="col-md-8">  
      ...
      <form action="{{route('books.store')}}"
        ...
        <!-- Penggunaan plugin Jquery yang bernama select2 -->
        <select 
          name="categories[]" 
          id="categories"
          multiple
        ...
        <input type="text" name="stock" id="stock" class="form-control" min=0 value=0>
        <br>
...
@section('footer-scripts')
  <!-- Untuk memanggil script Jquery Select2 -->
