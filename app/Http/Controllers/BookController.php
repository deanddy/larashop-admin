...
class BookController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    // Agar bisa menampilkan buku berstatus tertentu menggunakan query param. Contoh : books?/status=publish
  ...
  public function deletePermanent($id){
    ...
    if(!$book->trashed()){
      ...
      // detach() agar menghapus relationship buku yang akan dihapus dengan Category jika ada. Jika tidak kita lakukan kita akan mendapatkan error constraint violation dari mysql.
      $book->forceDelete();
