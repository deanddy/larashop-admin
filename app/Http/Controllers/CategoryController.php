...
class CategoryController extends Controller
{
  ...
  public function store(Request $request)
  {
		...
		//Mengecek apakah user menginput image, jika ada maka akakn di simpan di folder storage/app/public/categories_image
		...
		// Memberikan keterangan pembuat category pada di atribut created_by pada table
		$new_category->created_by = \Auth::user()->id;

		// Slug merupakan karakter yang tidak menyalahi aturan URL, artinya tidak ada spasi, huruf besar kecil, dsb. Misalnya nama kategori "Sepatu Olahraga" maka dengan \Str::slug("Sepatu Olahraga", "-") akan menghasilkan "sepatu-olahraga"
  ...
  {
		$categories_to_edit = \App\Category::findOrFail($id);
		
		return view('categories.edit', ['category' => $categories_to_edit]);
  }
  ...
  public function destroy($id)
  {
	...
	public function restore($id){
		...
		return redirect()->route('categories.index')->with('status', 'Category successfully restore');
	}
